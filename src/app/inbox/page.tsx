      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        ...
        {user.credits < 1 && unreadCount > 0 && (
          <div className="mb-6 p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg">
            ...
            <Link
              href="/write"
              className="inline-block px-6 py-2.5 bg-[#DDE3D5] dark:bg-[#3a4a2f] text-gray-900 dark:text-gray-100 text-sm rounded-full font-medium hover:bg-[#CDD3C5] dark:hover:bg-[#4a5a3f] hover:shadow-lg hover:shadow-[#DDE3D5]/30 dark:hover:shadow-[#3a4a2f]/30 transition-all duration-300"
            >
              Write a message
            </Link>
          </div>
