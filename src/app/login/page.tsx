      ...
      <div className="w-full max-w-sm text-center">
        ...
        {devLink && (
          <div className="mt-4 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg text-sm">
            <p className="text-gray-500 dark:text-gray-400 mb-2">Development mode:</p>
            <a href={devLink} className="text-blue-600 dark:text-blue-400 break-all hover:underline">
              Click here to login
            </a>
          </div>
        )}
