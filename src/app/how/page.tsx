    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <article className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg mb-4 text-gray-700 dark:text-gray-300">
            <p className="italic">
          ...
          <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <Link
              ...
              className="inline-block px-6 py-3 bg-[#DDE3D5] dark:bg-[#3a4a2f] text-gray-900 dark:text-gray-100 rounded-lg font-medium hover:bg-[#CDD3C5] dark:hover:bg-[#4a5a3f]"
            >
              Start writing
            </Link>
          </div>
